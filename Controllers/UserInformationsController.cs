...
namespace furni.Controllers
{
    ...
    {
        private UserDataEntities2 db = new UserDataEntities2();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Subject,Message")] UserInformation userInformation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Subject,Message")] UserInformation userInformation)
        {
            if (ModelState.IsValid)
            {
